...
public class SearchSuggestionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnBindSuggestionCallback {
        ...
        void onBindSuggestion(View suggestionView, ImageView leftIcon, ImageView rightIcon, ImageView deleteIcon, TextView textView, TextView usedBy,
    ...
    public interface Listener {
        ...
        void deleteSearchSuggestion(SearchSuggestion suggestionItem);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vh, final int position) {
        ...
        final SearchSuggestion suggestionItem = mSearchSuggestions.get(position);
        ...
        viewHolder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.deleteSearchSuggestion(suggestionItem);
                mSearchSuggestions.remove(position);
        ...
        if (mOnBindSuggestionCallback != null) {
            mOnBindSuggestionCallback.onBindSuggestion(viewHolder.itemView, viewHolder.leftIcon, viewHolder.rightIcon, viewHolder.delete, viewHolder.body, viewHolder.body,
    ...
    public static class SearchSuggestionViewHolder extends RecyclerView.ViewHolder {
        ...
        public SearchSuggestionViewHolder(View v, Listener listener) {
            ...
            usedBy = (TextView) v.findViewById(R.id.used_by);
