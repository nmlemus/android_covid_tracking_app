...
public class FloatingSearchView extends FrameLayout {
    ...
    private FloatingSearchView.OnSearchInputClickListener onSearchInputClickListener;

    public void setOnSearchInputClickListener(OnSearchInputClickListener onSearchInputClickListener) {
        this.onSearchInputClickListener = onSearchInputClickListener;
    }

    public FloatingSearchView.OnSearchInputClickListener getOnSearchInputClickListener() {
        return onSearchInputClickListener;
    }
    ...
    private ImageView mClearButton, mNotificationButton;
    private TextView textOne;
    private int mClearBtnColor;
    private Drawable mIconClear, mIconNotification;
    ...
    private void init(AttributeSet attrs) {
        ...
        initDrawables();
        mNotificationButton.setImageDrawable(mIconNotification);
    ...
    private void initDrawables() {
        ...
        mIconNotification = Util.getWrappedDrawable(getContext(), R.drawable.ic_notifications_black_24dp);
    ...
    private void setupQueryBar() {
        ...
        mSearchInput.setOnClickListener(new OnClickListener() {
            @Override public void onClick(View view) {
                if (onSearchInputClickListener != null){
                    onSearchInputClickListener.onSearchInputClickListener();
                }
            }
        });
    ...
    public void setClearBtnColor(int color) {
        ...
        DrawableCompat.setTint(mIconNotification, mClearBtnColor);
    }
     ...
     */
    public boolean setSearchFocused(final boolean focused, final boolean showSoftKeyboard) {
        ...
        if ((focused != this.mIsFocused) && mSuggestionSecHeightListener == null) {
            if (mIsSuggestionsSectionHeightSet) {
                setSearchFocusedInternal(focused, showSoftKeyboard);
            } else {
    ...
    private void setupSuggestionSection() {
        ...
        mSuggestionsAdapter = new SearchSuggestionsAdapter(getContext(), mSuggestionsTextSizePx,
            new SearchSuggestionsAdapter.Listener() {
                ...
                @Override
                public void deleteSearchSuggestion(SearchSuggestion suggestionItem) {
    ...
    private void setSearchFocusedInternal(final boolean focused, boolean showSoftKeyboard) {
    ...
    public void setNotificationCount(int cout) {
        textOne.setText(String.valueOf(cout));
    }
    ...
    public interface OnSearchInputClickListener {
        ...
        void onSearchInputClickListener();
