            ...
            locationResult
                    ...
                    ?.addOnSuccessListener(this) { location: Location? ->
                        ...
                        if (location == null) {
                            ...
                            val cameraLatitude: String = preferences.getString("cameraLatitude", null).toString();
                            val cameraLongitude: String = preferences.getString("cameraLongitude", null).toString();
                            ...
                            lastKnownLocation = LatLng(cameraLatitude.toDouble(), cameraLongitude.toDouble());
                        } else {
