...
package com.goblob.covid.geolocation.gpx;
...
import com.goblob.covid.geolocation.RejectionHandler;
...
class Gpx10AnnotateHandler implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(Gpx10AnnotateHandler.class);
    String description;
    File gpxFile;
    Location loc;
...
class Gpx10WriteHandler implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(Gpx10WriteHandler.class);
    String dateTimeString;
    Location loc;
    private File gpxFile = null;
    ...
    String getBeginningXml(String dateTimeString){
        ...
        initialXml.append("<gpx version=\"1.0\" creator=\"Goblob " + BuildConfig.VERSION_CODE + " - http://goblob.com/\" ");
