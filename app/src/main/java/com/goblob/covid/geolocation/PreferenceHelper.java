...
public class PreferenceHelper {
    ...
    public static PreferenceHelper getInstance(){
        if(instance==null){
            ...
            instance.prefs = PreferenceManager.getDefaultSharedPreferences(CovidApp.getInstance().getApplicationContext());
        }
    ...
    /**
     * GPS Logger folder path on phone.  Falls back to {@link com.goblob.covid.geolocation.Files#storageFolder(Context)} if nothing specified.
     */
    @ProfilePreference(name= PreferenceNames.GPSLOGGER_FOLDER)
    public String getGoblobFolder() {
        return prefs.getString(PreferenceNames.GPSLOGGER_FOLDER, Files.storageFolder(CovidApp.getInstance().getApplicationContext()).getAbsolutePath());
    }
    ...
    public String getCurrentProfileName() {
        return prefs.getString(PreferenceNames.CURRENT_PROFILE_NAME, CovidApp.getInstance().getString(R.string.profile_default));
    }
